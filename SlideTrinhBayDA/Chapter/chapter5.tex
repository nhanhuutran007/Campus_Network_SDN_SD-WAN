...
\begin{frame}{5.1 Kết luận tạm thời}
    \begin{enumerate}
        ...
        \par Mô hình EVE-NG đã dựng đủ 4 campus và hạ tầng liên quan; chi nhánh S400 đã hoạt động DHCP; SDN và SD-WAN đang được triển khai thực nghiệm, kế tiếp là kiểm tra chức năng và tổng hợp kết quả.
    \end{enumerate}
\end{frame}
