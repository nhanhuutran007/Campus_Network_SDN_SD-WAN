...
\begin{frame}{1.4 Phương pháp nghiên cứu}
    \begin{enumerate}
        ...
        \vspace{0.12cm}
        \item \textbf{Mô phỏng đối chiếu:} biểu diễn thiết kế trên EVE-NG để kiểm tra tính nhất quán của topology và luồng kết nối cơ bản.
    \end{enumerate}
    \vspace{0.15cm}
    \begin{block}{Trọng tâm giai đoạn hiện tại}
        Hoàn thiện nền tảng lý thuyết và thiết kế logic trước khi chuyển sang kiểm thử toàn hệ thống.
    \end{block}
\end{frame}
