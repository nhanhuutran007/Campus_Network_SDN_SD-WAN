...
\setbeamertemplate{frametitle}{%
  \begin{beamercolorbox}[wd=\paperwidth,ht=0.9cm,dp=0.1cm,center]{frametitle}%
    \begin{tikzpicture}[remember picture,overlay]
      \fill[accentTeal]
        ([xshift=0.5cm,yshift=-0.15cm]current page.north west)
        rectangle ++(0.16cm,-0.6cm);
    \end{tikzpicture}%
    \insertframetitle
  \end{beamercolorbox}%
...
\setbeamertemplate{footline}{%
  ...
  \begin{beamercolorbox}[wd=\paperwidth,ht=3.1ex,dp=1.2ex,leftskip=0.55cm,rightskip=0.55cm]{footline}%
    \small\textbf{\insertshorttitle}\hfill\insertframenumber\,/\,\inserttotalframenumber
  \end{beamercolorbox}%
}
