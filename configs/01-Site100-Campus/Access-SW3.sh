#!/bin/bash
# =============================================================
#  Access-SW3 - Access switch VLAN 30 - Khoa Luat (Node ID 70, OVS) - SDN managed
#  ens4 -> Dist-SW1 e3 (trunk) | ens5 -> Dist-SW2 e3 (trunk)
#  ens6, ens7 -> VPC15, VPC16 (access VLAN 30)
#  Mgmt:  10.1.99.23/24 (VLAN 99 qua bridge br-mgmt)
#  SDN:   datapath-id 70, controller 10.1.99.10:6653 (SDN_CONTROLLER, qua VLAN 99 mgmt)
...
ovs-vsctl set port ens6 tag=30
ovs-vsctl add-port br0 ens7
ovs-vsctl set port ens7 tag=30
...
ovs-vsctl set bridge br0 other_config:datapath-id=0000000000000046
