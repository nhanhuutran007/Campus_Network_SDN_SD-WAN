#!/bin/bash
# =============================================================
#  Dist-SW1 - Distribution switch (Node ID 5, OVS) - SDN managed
#  Trunk: ens4..ens10 (VLAN 10,20,30,40,90,99)
#  Mgmt:  10.1.99.11/24 (VLAN 99 qua bridge br-mgmt)
#  SDN:   datapath-id 5, controller 10.1.99.10:6653 (SDN_CONTROLLER, qua VLAN 99 mgmt)
#  ens4  -> Access-SW1 e1 | ens5 -> Access-SW2 e1 | ens6 -> Access-SW3 e1 | ens7 -> Access-SW4 e1
#  ens8  <-> Dist-SW2 e5 | ens9 -> Core-SW1 Gi0/2 | ens10 -> Core-SW2 Gi1/2
...
ovs-vsctl set bridge br0 other_config:datapath-id=0000000000000005
