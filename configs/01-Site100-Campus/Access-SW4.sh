#!/bin/bash
# =============================================================
#  Access-SW4 - Access switch VLAN 40 - Phong Hanh chinh (Node ID 69, OVS) - SDN managed
#  ens4 -> Dist-SW1 e4 (trunk) | ens5 -> Dist-SW2 e4 (trunk)
#  ens6, ens7 -> VPC17, VPC18 (access VLAN 40)
#  Mgmt:  10.1.99.24/24 (VLAN 99 qua bridge br-mgmt)
#  SDN:   datapath-id 69, controller 10.1.99.10:6653 (SDN_CONTROLLER, qua VLAN 99 mgmt)
...
ovs-vsctl set port ens6 tag=40
ovs-vsctl add-port br0 ens7
ovs-vsctl set port ens7 tag=40
...
ovs-vsctl set bridge br0 other_config:datapath-id=0000000000000045
