#!/bin/bash
# =============================================================
#  Access-SW1 - Access switch VLAN 10 - Khoa CNTT (Node ID 68, OVS) - SDN managed
#  ens4 -> Dist-SW1 e1 (trunk) | ens5 -> Dist-SW2 e1 (trunk)
#  ens6, ens7 -> VPC14, VPC19 (access VLAN 10)
#  Mgmt:  10.1.99.21/24 (VLAN 99 qua bridge br-mgmt)
#  SDN:   datapath-id 68, controller 10.1.99.10:6653 (SDN_CONTROLLER, qua VLAN 99 mgmt)
...
ovs-vsctl set port ens6 tag=10
ovs-vsctl add-port br0 ens7
ovs-vsctl set port ens7 tag=10
