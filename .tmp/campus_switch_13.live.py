...
class CampusSwitch13(app_manager.RyuApp):
    ...
    def _switch_features_handler(self, ev):
        ...
        # L2 thuan: table-miss -> NORMAL de OVS xu ly VLan-aware native
        # (push/pop tag, hoc MAC, flood dung VLAN). DHCP/data plane khong phu
        # thuoc vao controller. Cai lai moi lan switch ket noi -> tu hoi phuc.
