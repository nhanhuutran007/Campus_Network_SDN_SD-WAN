# ARCHIVE ONLY: tệp sinh ảnh Prism từ giai đoạn thiết kế cũ.
# Không dùng các IP/nhãn trong md_content làm nguồn triển khai hoặc nguồn báo cáo.
# Nguồn hiện hành: ../../campus_network_sdn_sdwan.md, ../../Campus Network SDN SD-WAN.unl
# và ../../configs/. Các ảnh cũ chỉ minh họa bố trí; Chương 3 đã ghi rõ thứ tự ưu tiên này.
import os
